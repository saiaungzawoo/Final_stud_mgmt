...
public class PdfReceiptGenerator {
    ...
    public static ByteArrayInputStream generate(
        ...
        else if(payment.getPaymentTypeName().equals("INSTALLMENT")) {
        ...
        addRow(table, "Payment Method", payment.getPaymentMethodName(), labelFont, valueFont, border);
        ...
        addRow(table, "Status", payment.getStatus(), labelFont, statusFont, border);

        document.add(table);
        
        if(payment.getPaymentTypeName().equals("INSTALLMENT")) {
            ...
            progress.setSpacingBefore(15);

            document.add(progress);



            PdfPTable progressTable =
                new PdfPTable(2);
            ...
            addRow(
                progressTable,
                "Remaining Balance",
                payment.getRemainingBalance()+" MMK",
                labelFont,
                valueFont,
                border
            );
            ...
            if(payment.getNextInstallmentNumber()!=null){
                ...
                nextTable.setWidthPercentage(100);
                ...
                addRow(
                    ...
                    "Installment",
                    String.valueOf(
                      payment.getNextInstallmentNumber()
                    ),
                    labelFont,
                    valueFont,
                    border
                ...
                addRow(
                    nextTable,
                    "Amount",
                    payment.getNextInstallmentAmount()+" MMK",
                    labelFont,
                    valueFont,
                    border
                );
