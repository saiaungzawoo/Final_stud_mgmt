 ...
 * com.finalproject.Final.model.CourseBean; import
 * com.finalproject.Final.model.EnrollmentBean; import
 * com.finalproject.Final.model.PaymentBean; import
 * com.finalproject.Final.service.CourseService; import
 * com.finalproject.Final.service.EnrollmentService; import
 * com.finalproject.Final.service.PaymentService;
 * 
 * @Controller
 * 
 ...
 * 
 * @GetMapping("/page/{enrollmentId}") public String paymentPage(@PathVariable
 * int enrollmentId, Model model) {
 * 
 ...
 * } }
 * 
 * // process payment // @PostMapping("/pay") // public String pay(PaymentDTO
 * dto) { // // paymentService.processPayment(dto); // // return
 * "redirect:/enrollment/my?userId=" + dto.getUserId(); // }
 * 
