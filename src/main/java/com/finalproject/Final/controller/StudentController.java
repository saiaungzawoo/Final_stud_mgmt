...
// me List<CourseBean> courses =
  // me enrollmentService.getEnrolledCourses(student.getId()); //
  
 //me model.addAttribute("student", student); model.addAttribute("studentCode",
 // me UserCodeUtil.formatUserCode(student.getRoleId(), student.getId()));
  
 //me model.addAttribute("courses", courses);
  //me model.addAttribute("enrolledCoursesCount", courses.size());
